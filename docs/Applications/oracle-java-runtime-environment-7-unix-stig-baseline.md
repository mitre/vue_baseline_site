...
InSpec profile to validate the secure configuration of JRE 7, against [DISA](https://iase.disa.mil/stigs/)'s **JRE 7 Security Technical Implementation Guide (STIG)**.
...
The following is an example of using this command. 
    ...
    inspec exec https://github.com/mitre/oracle-java-runtime-environment-7-unix-stig-baseline.git -t ssh://$myhost --user 'inspec_svc' --password=Pa55w0rd --sudo --sudo-password=sudoPa55w0rd --reporter cli json:jre7-results.json
...
To report a bug or feature request, please open an [issue](https://github.com/mitre/oracle-java-runtime-environment-7-unix-stig-baseline/issues/new).
...
This project is licensed under the terms of the [Apache 2.0 license](https://github.com/mitre/oracle-java-runtime-environment-7-unix-stig-baseline/blob/master/LICENSE.md).
